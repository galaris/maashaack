...
package examples 
{
    ...
    /**
     * Example of the Range class.
     */
    public class RangeExample extends Sprite 
    {
        public function RangeExample()
        {
            ...
            trace("Range.COLOR  : " + Range.COLOR  ) ;
            trace("Range.DEGREE : " + Range.DEGREE ) ;
            trace("Range.UNITY  : " + Range.UNITY  ) ;
        }
    }
}
