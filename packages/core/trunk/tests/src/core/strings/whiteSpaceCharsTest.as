...
package core.strings 
{
    ...
    public class whiteSpaceCharsTest extends TestCase 
    {
        public function whiteSpaceCharsTest(name:String = "")
        {
            super(name);
        }
        ...
        {
            assertTrue( whiteSpaceChars.indexOf("\u0009") > -1 ) ;
            assertTrue( whiteSpaceChars.indexOf("\u000A") > -1 ) ;
            assertTrue( whiteSpaceChars.indexOf("\u000B") > -1 ) ;
            assertTrue( whiteSpaceChars.indexOf("\u000C") > -1 ) ;
            assertTrue( whiteSpaceChars.indexOf("\u000D") > -1 ) ;
            assertTrue( whiteSpaceChars.indexOf("\u0020") > -1 ) ;
