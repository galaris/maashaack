...
package core.chars 
{
    ...
    {
        public function isWhiteSpaceTest(name:String = "")
        {
            super(name);
        }
        ...
        public function testWhiteSpace():void
        {
            ...
            assertFalse( isWhiteSpace( "a" ) , "#2" );
        }
        
        public function testWhiteSpaceIndex():void
        {
            assertFalse( isWhiteSpace( "a b" , 0 ) , "#1" ) ;
            assertTrue( isWhiteSpace(  "a b" , 1 ) , "#2" ) ;
            assertFalse( isWhiteSpace( "a b" , 2 ) , "#3" ) ;
        }
    }
}
