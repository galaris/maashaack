...
package core.strings 
{
    ...
    public class hexformatTest extends TestCase 
    {
        public function hexformatTest(name:String = "")
        {
            super(name);
        }
        
        public function testHexformatDefault():void
        {
            var byteArray:ByteArray = new ByteArray() ;
            assertEquals( "" , hexformat( byteArray ) , "#1" ) ;
            assertEquals( "" , hexformat( null ) , "#2" ) ;
        }
        
        public function testHexformatBasic():void
        {
            var byteArray:ByteArray = new ByteArray() ;
            var result:String ;
