...
package core.maths
{
     ...
     * @return the normalize representation of the specified value in the specific range defines in the arguments of the function.
     */
    public const normalize:Function = function( value:Number, minimum:Number, maximum:Number):Number
    {
