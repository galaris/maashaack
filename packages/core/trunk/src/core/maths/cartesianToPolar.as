...
package core.maths
{
     ...
     */
    public const cartesianToPolar:Function = function( vector:* , degrees:Boolean = false ):Object  
    {
        return ( { angle :  Math.atan2(vector.y,vector.x) * ( degrees ? RAD2DEG : 1 ) , radius : Math.sqrt(vector.x*vector.x+vector.y*vector.y) } ) ;
    };
}
