...
package system.ioc
{
    ...
    public class ObjectScopeTest extends TestCase
    {
        ...
        {
            ArrayAssert.assertEquals( ["prototype", "singleton"]  , ObjectScope.SCOPES ) ;
        }
        ...
        public function testValidate():void
        {
            ...
            assertTrue( ObjectScope.validate( ObjectScope.PROTOTYPE ) ) ;
            assertTrue( ObjectScope.validate( ObjectScope.SINGLETON ) ) ;
            
            assertFalse( ObjectScope.validate( null ) )  ;
