...
package system.rules
{
     ...
     * </listing>
     */
    public class False implements Rule
    {
        /**
         * Creates a new False instance.
         * @param condition The Boolean value or the Rule object to evaluate.
         */
        public function False(condition:* = null)
        {
        ...
        {
            return ( ( condition is Rule ) ? (condition as Rule).eval() : Boolean( condition ) ) == false ;
        }
    }
}
