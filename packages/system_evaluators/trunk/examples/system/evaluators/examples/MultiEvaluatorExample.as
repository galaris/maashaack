...
package examples 
{
    ...
    public class MultiEvaluatorExample extends Sprite 
    {
        public function MultiEvaluatorExample()
        {
            ...
            trace("evaluate new Date(2007,5,12,22,10,5) : " + result ) ; // evaluate new Date(2007,5,12,22,10,5) : 12.06.2007 22:10:05
