...
package system.formatters 
{
    ...
    public class ExpressionFormatterTest extends TestCase 
    {
        ...
        public function ExpressionFormatterTest(name:String = "")
        {
            super(name);
        }
        ...
        public function testConstructor():void
        {
            ...
            assertNotNull(new ExpressionFormatter(true), "02 - The ExpressionFormatter constructor failed with the weakReference argument.") ;
        }
