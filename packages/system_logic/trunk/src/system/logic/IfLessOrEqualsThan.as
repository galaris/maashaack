...
package system.logic
{
     ...
     * package examples
     * {
     *     import system.process.logic.IfLessOrEqualsThan;
     *     
     ...
     *             var value2:uint = 20 ;
     *             
     *             task = new IfLessOrEqualsThan( value1 , value2 , new Then(), new Else() ) ;
     *             task.run() ; // else
     *             
     *             task = new IfLessOrEqualsThan( value2 , value1, new Else() ) ;
     *             task.run() ; // then
     *             
     *             task = new IfLessOrEqualsThan( value1 , value1 , new Then(), new Else() ) ;
     *             task.run() ; // then
     *         }
     *     }
     * }
     ...
     * </code>
     * </listing>
     * @see system.rules.LessOrEqualsThan
     */
    public class IfLessOrEqualsThan extends IfTask
    {
        /**
         ...
         */
        public function IfLessOrEqualsThan( value1:* , value2:* , thenTask:Action = null , elseTask:Action = null , ...elseIfTasks:Array )
        {
            super( new LessOrEqualsThan( value1 , value2 ) , thenTask , elseTask ) ;
