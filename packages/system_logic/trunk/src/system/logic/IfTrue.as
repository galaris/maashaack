...
package system.logic
{
    ...
    public class IfTrue extends IfTask
    {
         ...
         * @param condition The condition who must be true.
         ...
         */
        public function IfTrue( condition:* , thenTask:Action = null , elseTask:Action = null , ...elseIfTasks:Array )
        {
            super( new True( condition ) , thenTask , elseTask ) ;
