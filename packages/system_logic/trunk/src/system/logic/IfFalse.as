...
package system.logic
{
    ...
    public class IfFalse extends IfTask
    {
         ...
         * @param condition The condition who must be false.
         ...
         */
        public function IfFalse(condition:*, thenTask:Action = null, elseTask:Action = null, ...elseIfTasks:Array)
        {
            super( new False( condition ) , thenTask , elseTask ) ;
