...
package system.logic
{
     ...
     * package examples
     * {
     *     import system.process.logic.IfGreaterOrEqualsThan;
     *     
     ...
     *             var value2:uint = 20 ;
     *             
     *             task = new IfGreaterOrEqualsThan( value1 , value2 , new Then(), new Else() ) ;
     *             task.run() ; // else
     *             
     *             task = new IfGreaterOrEqualsThan( value2 , value1, new Else() ) ;
     *             task.run() ; // then
     *             
     *             task = new IfGreaterOrEqualsThan( value1 , value1 , new Then(), new Else() ) ;
     *             task.run() ; // then
     *         }
     *     }
     * }
     ...
     */
    public class IfGreaterOrEqualsThan extends IfTask
    {
        /**
         ...
         */
        public function IfGreaterOrEqualsThan( value1:* , value2:* , thenTask:Action = null , elseTask:Action = null , ...elseIfTasks:Array )
        {
            super( new GreaterOrEqualsThan( value1 , value2 ) , thenTask , elseTask ) ;
