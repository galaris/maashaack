...
package system.logic
{
     ...
     * package examples
     * {
     *     import system.process.logic.IfLessThan;
     *     
     ...
     *             var value2:uint = 20 ;
     *             
     *             task = new IfLessThan( value1 , value2 , new Then(), new Else() ) ;
     *             task.run() ; // then
     *             
     *             task = new IfLessThan( value2 , value1, new Else() ) ;
     *             task.run() ; // else
     *             
     *             task = new IfLessThan( value1 , value1 , new Then(), new Else() ) ;
     *             task.run() ; // else
     *         }
     *     }
     * }
     ...
     * </code>
     * </listing>
     * @see system.rules.LessThan
     */
    public class IfLessThan extends IfTask
    {
        /**
         ...
         */
        public function IfLessThan( value1:* , value2:* , thenTask:Action = null , elseTask:Action = null , ...elseIfTasks:Array )
        {
            super( new LessThan( value1 , value2 ) , thenTask , elseTask ) ;
