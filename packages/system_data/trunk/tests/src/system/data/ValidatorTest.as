...
package system.data 
{
    ...
    public class ValidatorTest extends TestCase 
    {
        ...
        public function testSupports():void
        {
            ...
            assertTrue( o.supports("hello world") , "01 - Must support a String value in argument.") ;
            assertFalse( o.supports(1) , "02 - Must support a String value in argument and not a number.") ;
        }
