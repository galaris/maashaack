...
package system.data 
{
    ...
    {
        public function WeakReferenceTest(name:String = "")
        {
            super(name);
        }
        ...
        public function testDispose():void
        {
            var wr:WeakReference = new WeakReference( { prop:"value" } ) ;
            wr.dispose() ;
            assertNull( wr.value , "WeakReference dispose method failed.") ;
        }
        
        public function testToString():void
        {
            var wr:WeakReference = new WeakReference( { prop:"value" } ) ;
            assertEquals( wr.toString() , "[WeakReference [object Object]]" , "WeakReference toString method failed.") ;
        }
    }
}
