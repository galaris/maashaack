...
package graphics.filters 
{
    ...
    public class DonutFilterTest extends TestCase 
    {
        public function DonutFilterTest(name:String = "")
        {
            super(name);
        }
        
        public var count:Number = 10 ;
        
        public var filter:DonutFilter ;
        
        public var shader:Shader ;
        
        public function setUp():void
        {
            shader = new Shader( new Donut() ) ;
            filter = new DonutFilter( shader , { count : count } ) ;
        }
        ...
        public function testConstructor():void
        {
            ...
            assertEquals( filter.count , count ) ;
        }
        
        public function testDescription():void
        {
            assertEquals( filter.description , "Pixelate an input image and tile it with donut like shapes." ) ;
        }
        
        public function testName():void
        {
            assertEquals( filter.name , "Donut" ) ; 
        }
        ...
        {
            var clone:DonutFilter = filter.clone() as DonutFilter ;
