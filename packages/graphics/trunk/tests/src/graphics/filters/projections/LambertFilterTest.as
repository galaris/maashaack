...
package graphics.filters.projections 
{
    ...
    public class LambertFilterTest extends TestCase 
    {
        public function LambertFilterTest(name:String = "")
        {
            super(name);
        }
        
        public var filter:LambertFilter ;
        public var shader:Shader ;
        
        public function setUp():void
        {
            shader = new Shader( new Lambert() ) ;
            filter = new LambertFilter( shader ) ;
        }
        ...
        {
            filter = new LambertFilter( shader  , { height:300, width:150 , fieldOfView:400 , focalLength:500 } ) ;
        ...
        {
            assertEquals( "In geometry, the Lambert projection is a conic map projection." , filter.description ) ;
        }
        
        public function testName():void
        {
            assertEquals( "Lambert" , filter.name ) ; 
        }
        ...
        {
            var clone:LambertFilter ;
            
            clone = filter.clone() as LambertFilter ;
