...
package graphics.filters.projections 
{
    ...
    public class OrthographicFilterTest extends TestCase 
    {
        public function OrthographicFilterTest(name:String = "")
        {
            super(name);
        }
        ...
        {
            shader = new Shader( new Orthographic() ) ;
            filter = new OrthographicFilter( shader ) ;
        }
        ...
        {
            filter = new OrthographicFilter( shader  , { height:300, width:150 , fieldOfView:400 , focalLength:500 } ) ;
        ...
        {
            assertEquals( "In geometry, the orthographic projection is a perspective (or azimuthal) projection, in which the sphere is projected onto a tangent plane or secant plane." , filter.description ) ;
        }
        
        public function testName():void
        {
            assertEquals( "Orthographic" , filter.name ) ; 
        }
        ...
        {
            var clone:OrthographicFilter ;
            
            clone = filter.clone() as OrthographicFilter ;
