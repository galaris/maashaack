...
package graphics 
{
    ...
    {
        public function DirectionTest(name:String = "")
        {
            super(name);
        }
        ...
        {
            assertEquals( Direction.HORIZONTAL , "horizontal" , "Direction.HORIZONTAL constant failed.") ;
        }
        ...
        {
            assertEquals( Direction.VERTICAL , "vertical" , "Direction.VERTICAL constant failed.") ;
        }
    }
}
