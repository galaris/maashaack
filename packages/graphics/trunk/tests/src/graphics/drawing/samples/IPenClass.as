...
package graphics.drawing.samples 
{
    ...
    public class IPenClass implements IPen 
    {
        public function IPenClass()
        {
            //
        }
        ...
        {
            throw new Error( "draw : " + arguments )  ;
        }
        
        public function drawShape():void
        {
            throw new Error( "drawShape." )  ;
        }
    }
}
