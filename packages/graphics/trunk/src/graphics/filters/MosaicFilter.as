...
package graphics.filters 
{
     ...
     * The Shader must be defines with the Mosaic pixelbender implementation.
     */
    public class MosaicFilter extends ShaderCustomFilter 
    {
        /**
         * Creates a new MosaicFilter instance.
         * @param shader The Shader reference with the Mosaic pixel bender filter inside.
        ...
        {
            super( shader || new Shader( new Mosaic() ) , init ) ;
        }
        ...
        {
            return new MosaicFilter( null, shader ) ;
        }
    }
}
