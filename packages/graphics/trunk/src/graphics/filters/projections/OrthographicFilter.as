...
package graphics.filters.projections 
{
     ...
     * The Shader must be defines with the Orthographic pixelbender implementation.
     */
    public class OrthographicFilter extends ShaderCustomFilter 
    {
        /**
         * Creates a new OrthographicFilter instance.
         * @param shader The Shader reference with the Orthographic pixel bender filter inside.
         * @param init The optional dynamic object to initialize the filter.
         */
        public function OrthographicFilter( shader:Shader = null , init:Object = null )
        {
            super( shader || new Shader( new Orthographic() ) , init);
        }
        ...
        {
            return new OrthographicFilter( shader , { width:width , height:height , focalLength:focalLength , fieldOfView:fieldOfView }) ;
        }
    }
}
