...
package graphics.display.palettes
{
     ...
     * @param source  The BitmapData to transform.
     * @param colors The number of colours to reduce the BitmapData to.
     */
    public function reduce( source:BitmapData, colors:int = 16 ):void
    {
