...
{
    import graphics.rules.display.NotContains;
     ...
     * 
     * var rule:NotContains = new NotContains( container , child ) ;
     * 
     * trace( rule.eval() ) ;
     * 
     ...
     * </listing>
     */
    public class IfNotContains extends IfTask
    {
        /**
         * Creates a new IfNotContains instance.
         * @param container The container reference to evaluate.
         * @param child The child DisplayObject reference to evaluate.
         ...
         */
        public function IfNotContains( container:DisplayObjectContainer = null , child:DisplayObject = null , thenTask:Action = null, elseTask:Action = null, ...elseIfTasks:Array )
        {
            super( new NotContains( container , child ) , thenTask, elseTask ) ;
