...
{
    import graphics.rules.display.Contains;
     ...
     * 
     * var rule:Contains = new Contains( container , child ) ;
     * 
     * trace( rule.eval() ) ;
     * 
     ...
     * </listing>
     */
    public class IfContains extends IfTask
    {
        /**
         * Creates a new IfContains instance.
         ...
         */
        public function IfContains( container:DisplayObjectContainer = null , child:DisplayObject = null , thenTask:Action = null, elseTask:Action = null, ...elseIfTasks:Array )
        {
            super( new Contains( container , child ) , thenTask, elseTask ) ;
