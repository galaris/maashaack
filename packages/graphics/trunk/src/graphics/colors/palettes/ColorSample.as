...
package graphics.colors.palettes
{
    ...
    /**
     * The basic color definition.
     */
    public class ColorSample
    {
        /**
         * Creates a new ColorSample instance.
         * @param name The name of the color
         * @param rgb The rgb reference of the color.
         */
        public function ColorSample( name:String = null , rgb:RGB = null )
        {
            this.name = name ;
            this.rgb  = rgb  ;
        }
