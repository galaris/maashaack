...
package graphics 
{
    ...
    /**
     * Defines the line style of the vector shapes. See the flash.display.graphics.lineBitmapStyle method.
     */
    public class LineBitmapStyle implements IFillStyle
    {
        /**
         * Creates a new LineBitmapStyle instance.
         ...
         */
        public function LineBitmapStyle( bitmap:BitmapData = null , matrix:Matrix = null, repeat:Boolean = true, smooth:Boolean = false )
        {
            this.bitmap  = bitmap ;
            this.matrix  = matrix ;
            this.repeat  = repeat ;
        ...
        {
            graphic.lineBitmapStyle( bitmap , matrix , repeat , smooth );
        }
        ...
        {
            return new LineBitmapStyle( bitmap , matrix, repeat, smooth ) ;
        }
        ...
        {
            var s:LineBitmapStyle = o as LineBitmapStyle ;
            if ( s )
            {
        ...
        public function toSource(indent:int = 0):String
        {
            var m:String = (matrix == null) ? "null" : "new flash.geom.Matrix("
                           ...
                           + String( matrix.ty ) 
                           + ")" ;
            var source:String = "new graphics.LineBitmapStyle(null,"
                              + m + ","
                              + dump( repeat ) + ","
                              + dump( smooth ) 
                              + ")" ;
