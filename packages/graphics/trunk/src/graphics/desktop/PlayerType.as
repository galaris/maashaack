...
{
    /**
     * The PlayerType enumeration of all strings that indicates the type of player.
     */
    public final class PlayerType
    {
        ...
        /**
         * For the Adobe AIR runtime (except for SWF content loaded by an HTML page, which has Capabilities.playerType set to "PlugIn")
         */
