...
{
    /**
     * The <code class="prettyprint">sineIn</code> function starts motion from zero velocity and then accelerates motion as it executes. 
     ...
     */
    public const sineIn:Function = function( t:Number, b:Number, c:Number, d:Number ):Number
    {
