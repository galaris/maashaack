...
{
    /**
     * The <code class="prettyprint">bounceInOut</code> function combines the motion of the <code class="prettyprint">bounceIn</code> and <code class="prettyprint">bounceOut</code> functions 
     ...
     */
    public const bounceInOut:Function = function( t:Number, b:Number, c:Number, d:Number ):Number
    {
