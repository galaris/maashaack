...
{
    /**
     * The <code class="prettyprint">sineOut</code> function starts motion fast and then decelerates motion to a zero velocity as it executes. 
     ...
     */
    public const sineOut:Function = function( t:Number, b:Number, c:Number, d:Number ):Number
    {
