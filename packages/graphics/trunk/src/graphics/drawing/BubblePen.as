...
package graphics.drawing 
{
    ...
    public class BubblePen extends RoundedComplexRectanglePen 
    {
         ...
         */
        public function BubblePen( graphic:* = null , x:Number = 0, y:Number = 0, width:Number = 0, height:Number = 0, topLeftRadius:Number = 0, topRightRadius:Number = 0, bottomRightRadius:Number = 0 , bottomLeftRadius:Number = 0, align:uint = 10)
        {
