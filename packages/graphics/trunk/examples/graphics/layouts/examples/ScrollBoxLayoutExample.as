...
package examples 
{
    ...
    public class ScrollBoxLayoutExample extends Sprite 
    {
        public function ScrollBoxLayoutExample()
        {
            ...
            trace( "> maxscroll::" + layout.maxscroll + " scroll:" + layout.scroll + " bottomScroll:" + layout.bottomScroll ) ;
         ...
         */
        protected function update( layout:ScrollBoxLayout ):void
        {
