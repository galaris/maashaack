...
package system.evaluators
    ...
    public class MathEvaluatorTest extends TestCase
        ...
        public function setUp():void
            ...
            _ME2 = new MathEvaluator( {x:100, test:function(a:Number):Number {return a*a;}, test2:function(a:Number):Number {return a*a*2;} } );
            }
        ...
        public function testFunctionCall():void
            ...
            assertNotNull( _ME.eval( "random()" ) ); //unless we can control the random seed we can not assertEquals 2 different random call
