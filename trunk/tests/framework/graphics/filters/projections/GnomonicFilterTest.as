...
package graphics.filters.projections 
{
    ...
    public class GnomonicFilterTest extends TestCase 
    {
        public function GnomonicFilterTest(name:String = "")
        {
            super(name);
        }
        
        public var filter:GnomonicFilter ;
        public var shader:Shader ;
        
        public function setUp():void
        {
            shader = new Shader( new Gnomonic() ) ;
            filter = new GnomonicFilter( shader ) ;
        }
        ...
        {
            filter = new GnomonicFilter( shader  , { height:300, width:150 , fieldOfView:400 , focalLength:500 } ) ;
        ...
        {
            assertEquals( "The gnomonic azimuthal projection is a nonconformal map projection (standard perspective)." , filter.description ) ;
        }
        
        public function testName():void
        {
            assertEquals( "Gnomonic" , filter.name ) ; 
        }
        ...
        {
            var clone:GnomonicFilter ;
            
            clone = filter.clone() as GnomonicFilter ;
