 ...
 */
core.maths.polarToCartesian = function( vector , degrees /*Boolean*/ ) /*Object*/ 
{
    var angle /*Number*/  = vector.angle ;
    var radius /*Number*/ = vector.radius ;
    if ( degrees )
    {
        angle *= core.maths.DEG2RAD ;
    }
