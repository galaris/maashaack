...
package examples 
{
    import graphics.filters.projections.StereographicFilter;
     ...
     */
    public class StereographicFilterExample extends Sprite 
    {
        public function StereographicFilterExample()
        {
            // stage
            ...
            filter = new StereographicFilter() ;
