...
package examples
{
    ...
    public class RoundedRectanglePenExample extends Sprite 
    {
        public function RoundedRectanglePenExample()
        {
            ...
            pen            = new RoundedRectanglePen( shape , 0, 0, 100, 80, 12, NaN,  Align.CENTER ) ;
            pen.useClear   = true ;
            pen.useEndFill = true ;
        ...
        public var pen:RoundedRectanglePen ;
        ...
        public function keyDown( e:KeyboardEvent ):void
        {
            ...
            switch( code )
            {
                case Keyboard.LEFT :
                {
                    pen.draw( 0, 0, 100, 80, 60, 60,  Align.LEFT ) ;
                    break ;
                }
                case Keyboard.RIGHT :
                {
