...
package system.process 
{
    ...
    public class ActionEntry implements Priority
    {
         ...
         * @param auto Indicates if the action must be removed when handle the first time the finish phase of the process. 
         */
        ...
        {
            return "[ActionEntry action:" + action + " priority:" + _priority + " auto:" + auto + "]" ;
        }
