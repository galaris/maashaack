...
package graphics 
{
    ...
    public class LineGradientStyle extends GradientStyle implements ILineStyle
    {
         ...
         */
        public function LineGradientStyle( type:String = null , colors:Array = null , alphas:Array = null , ratios:Array = null , matrix:Matrix = null, spreadMethod:String = "pad", interpolationMethod:String = "rgb", focalPointRatio:Number = 0 )
        {
