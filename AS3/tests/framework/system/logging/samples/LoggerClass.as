...
package system.logging.samples 
{
    ...
    public class LoggerClass extends EventDispatcher implements Logger 
    {
        ...
        public function error(context:*, ...rest:Array):void
        {
            throw new Error( Strings.format.apply( this, [context].concat(rest) ) ) ;
        }
        
        public function fatal(context:*, ...rest:Array):void
        {
            throw new Error( Strings.format.apply( this, [context].concat(rest) ) ) ;
        }
        
        public function info(context:*, ...rest:Array):void
        {
            throw new Error( Strings.format.apply( this, [context].concat(rest) ) ) ;
        }
        ...
        public function warn(context:*, ...rest:Array):void
        {
            throw new Error( Strings.format.apply( this, [context].concat(rest) ) ) ;
        }
    }
