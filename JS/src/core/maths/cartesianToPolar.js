 ...
 */
core.maths.cartesianToPolar = function( vector , degrees /*Boolean*/ ) /*Object*/ 
{
    return ( { angle :  Math.atan2(vector.y,vector.x) * ( Boolean(degrees) ? core.maths.RAD2DEG : 1 ) , radius : Math.sqrt(vector.x*vector.x+vector.y*vector.y) } ) ;
}
