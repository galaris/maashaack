...
package avmplus
{
    ...
    /**
     * The StandardStream interface
     * Defines methods to access and manipulate standard streams: stdin, stdout and stderr.
     * 
     * 
     * @langversion 3.0
     ...
     * @since 0.3.2
     * 
     * @see http://code.google.com/p/redtamarin/wiki/StandardStream
     */
    public interface StandardStream
    {
        /**
         * Reads the amount of <code>lenght</code> (or all) from the stream in text mode.
         */
        function read( length:uint = 0 ):String;

        /**
         * Reads the amount of <code>lenght</code> (or all) from the stream in binary mode.
         */
