...
package avmplus
{
    ...
    internal class StandardStreamIn implements StandardStream
    {
        private var _type:String;
        
        public function StandardStreamIn()
        {
            _type = "stdin";
        }
        ...
        {
            var bytes:ByteArray = readBinary( length );
        ...
        public function readBinary( length:uint = 0 ):ByteArray
        {
            if( length > 0 )
            {
                return System.hack_sys::stdinRead( length );
            }
            else
            {
                return System.hack_sys::stdinReadAll();
            }
        }
        
        public function write( data:String ):void
        {
            throw new IllegalOperationError( "can not write on stream " + _type );
        }
