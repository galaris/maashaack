...
package flash.utils
{
     ...
     * This interface is the I/O counterpart to the IDataInput interface, which reads binary data.
     * The IDataOutput interface is implemented by the FileStream, Socket and ByteArray classes.
     * 
