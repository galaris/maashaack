...
package flash.system
{
    ...
    public final class ApplicationDomain
    {
        ...
        private var _parent:ApplicationDomain;
        ...
        private function ctor( parentDomain:ApplicationDomain ):void
        {
            _parent = parentDomain;
            _domainMemory = new ByteArray();
        }
    ...
    public final class ApplicationDomain
    {
        ...
        private function ctor( parentDomain:* ):void
        {
        ...
        //public native function set domainMemory( mem:ByteArray ):void;
        [API(CONFIG::FP_10_0,CONFIG::AIR_1_5)]
        public function set domainMemory( mem:ByteArray ):void
        {
