...
package flash.events
{
    ...
    public class TimerEvent extends Event
    {
        ...
        {
            CFG::dbg{ trace( "new TimerEvent( " + [type,bubbles,cancelable].join(", ") + " )" ); }
            super( type, bubbles, cancelable );
        }

        override public function clone():Event
        {
            CFG::dbg{ trace( "TimerEvent.clone()" ); }
            return new TimerEvent( type, bubbles, cancelable );
        }
        
        override public function toString():String
        {
            CFG::dbg{ trace( "TimerEvent.toString()" ); }
        ...
        {
            CFG::dbg{ trace( "TimerEvent.updateAfterEvent()" ); }
            /* note:
               nothing to do really as we have no GUI to update.
            */
        }
    }
}
